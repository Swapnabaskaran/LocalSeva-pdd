...
export const BackgroundCheckStatusScreen: React.FC<any> = ({ navigation }) => {
  const formattedTitle = "BackgroundCheckStatusScreen".replace(/Screen$/, '').replace(/([A-Z])/g, ' $1').trim();
...
export default BackgroundCheckStatusScreen;
