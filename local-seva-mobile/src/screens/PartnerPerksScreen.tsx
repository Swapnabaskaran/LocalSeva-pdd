...
export const PartnerPerksScreen: React.FC<any> = ({ navigation }) => {
  const formattedTitle = "PartnerPerksScreen".replace(/Screen$/, '').replace(/([A-Z])/g, ' $1').trim();
...
export default PartnerPerksScreen;
